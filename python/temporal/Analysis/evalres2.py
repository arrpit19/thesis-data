...
def evalres2():
    ...
    data_file1 = "C:/Users/Arpit/Documents/ProfoundData/traindataSSscaled.csv"
    data_file2 = "C:/Users/Arpit/Documents/ProfoundData/Ytrain.csv"
    ...
    yptr = pd.read_csv("C:/Users/Arpit/Documents/ProfoundData/ytrainpred.csv")
    ...
    pd.DataFrame({"f1": t1, "f2": t2, "f3":t3}).to_csv('res2_trainloss.csv')
    v1 = []
    v2 = []
    v3 = []
    ...
    pd.DataFrame({"f1": v1, "f2": v2, "f3":v3}).to_csv('res2_vloss.csv')
    ...
    pd.DataFrame.from_dict(performance).to_csv('res2_evalperformance.csv')
...
test_y = pd.read_csv("C:/Users/Arpit/Documents/ProfoundData/gpptest2008.csv" )
resmlp = pd.read_csv("C:/Users/Arpit/Documents/ProfoundData/ypred2008cali.csv")
plt.plot(range(len(test_y)), test_y['GPP'], label='Observed GPP', marker='o')
plt.plot(range(len(resmlp)), resmlp['x'], label='Predicted GPP by Calibrated R3pgn model', marker='o')

# Customize the plot
plt.title("GPP plot 2008 R3PGN Model", fontsize=16)
