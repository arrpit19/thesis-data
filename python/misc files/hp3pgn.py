...
def NASSearch(agrid,pgrid, X, Y, splits, data, reg=None, emb=False, raw=None, res=None, y3pgn=None, exp=None, hp=False):
    ...
    for i in range(len(agrid)):
        ...
        for p in range(len(pgrid)):
            ...
            running_losses = training3pgn.train_cv(hparams, model_design, X, Y, "../../data/" , splits, data, reg=reg, emb=emb, raw=raw, res=res, y3pgn=y3pgn, exp=exp, hp=hp) # train model
